...
QT_MOC_LITERAL(1, 8, 21), // "on_pushButton_pressed"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "ToolTip\0on_pushButton_pressed\0"
};
...
const QMetaObject ToolTip::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ToolTip.data,
      qt_meta_data_ToolTip,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ToolTip::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ToolTip.stringdata0))
        return static_cast<void*>(const_cast< ToolTip*>(this));
